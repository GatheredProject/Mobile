...
export default function ConfirmEmail() {
    ...
    <SafeAreaView style={styles.ScreenContainer}>
        ...
        <Image 
            ...
            source={require('@/assets/images/confirmEmail/gathered-mobile-confirmEmail.png')} 
            contentFit='contain'
        />  
           <View>
                ...
                <ScrollView scrollEnabled={false}>
                    <View
                        ...
                        <Text style={ styles.TextBody }>
                            ...
                            We’ve sent a confirmation link to your inbox — just click to verify. 
                        </Text>
                        ...
                        <TouchableHighlight 
                            ...
                            onPress={() => console.log("Sending Email Link")}
                            underlayColor={'#ffdda1'}
                            activeOpacity={0.6}
                        >
                            <Text style={styles.ConnectButtonText}>Resend Email Link</Text> 
                        </TouchableHighlight>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView> 
